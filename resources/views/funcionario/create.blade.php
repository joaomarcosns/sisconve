            ...
            <div class="form">
                <form action="">
                    <div class="input input-nome-funcionario">
                        ...
                        <input type="text" name="nome_funcionario" placeholder="José da Silva" maxlength="100" required>
                    </div>
                    <div class="input-cpf-tel">
                        <div class="input input-cpf">
                            <label for="cpf">CPF <small>(somente números)</small></label>
                            <input type="text" name="cpf" placeholder="123.456.789-10" maxlength="11" required>
                        </div>
                        <div class="input input-num-telefone">
                            <label for="telefone">Telefone + DDD <small>(somente números)</small></label>
                            <input type="text" name="telefone" placeholder="(38) 9 12345678" maxlength="11" required>
                        </div>
                    </div>
                    <div class="input input-email">
                        <label for="email">E-mail</label>
                        <input type="text" name="email" placeholder="funcionario@email.com" maxlength="30" required>
                    </div>
                    <div class="input input-endereco">
                        <label for="endereco">Endereço <small>(completo)</small></label>
                        <input type="text" name="endereco" placeholder="Rua dos Cocais, num 25 Bairro Centro, Espinosa-MG" maxlength="100" required>
                    </div>
                    <div class="input-cargo-salario">
                        <div class="input input-cargo">
                            <label for="cargo">Cargo</label>
                            <input type="text" name="cargo" placeholder="Caixa" maxlength="20" required>
                        </div>
                        <div class="input input-salario">
                            <label for="salario">Salário R$ <small>(somente números)</small></label>
                            <input type="number" name="salario" placeholder="1500,00" min="0" max="99999" required>
                        </div>
                    </div>
                    ...
                    <div class="input-usuario-nivel">
                        <div class="input input-usuario">
                            ...
                            <input type="text" style="background-color: #e5e5e5;" name="usuario" id="usuario" placeholder="usuario" maxlength="50" required disabled>
                        </div>
                    ...
                    <div class="input-senha-confirm">
                        <div class="input input-senha">
                            ...
                            <input type="password" style="background-color: #e5e5e5;" name="senha" id="senha" placeholder="•••••••••••" maxlength="100" required disabled>
                        </div>
                        <div class="input input-conf-senha">
                            <label for="confirma_senha">Confirmar senha</label>
                            <input type="password" style="background-color: #e5e5e5;" name="confirma_senha" id="confi-senha" placeholder="•••••••••••" maxlength="100" required disabled>
                            <div id="pw-wrong"></div>
                        </div>
                    </div>
